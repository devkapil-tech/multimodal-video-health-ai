...
async function uploadVideo(url, { arg: { file, exerciseType, patientToken } }) {
...
export default function UploadPanel({ onResult, onLoading, exerciseType = "general", patientToken = "" }) {
  ...
  const handleUpload = () => {
    ...
    onLoading(true);
    onResult(null);
    trigger({ file, exerciseType, patientToken });
  };
